...
class AdminEditLivroFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val exemplares: EditText = view.findViewById(R.id.admin_edit_livro_exemplares)
        ...
        val editarBtn: Button = view.findViewById(R.id.admin_edit_livro_cancelar)
        val cancelarBtn: Button = view.findViewById(R.id.admin_edit_livro_confirmar)
